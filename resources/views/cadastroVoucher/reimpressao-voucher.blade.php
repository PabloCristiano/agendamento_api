...
<head>
  ...
  <title>Foz Tintas - Reimprimir Voucher</title>
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .hero h1 { font-size:3.2rem; font-weight:800; margin-bottom:12px; text-shadow:2px 2px 4px rgba(0,0,0,.3); }
    ...
    .voucher-form-section {
      ...
      padding:40px; margin:40px 0; box-shadow:0 15px 40px rgba(0,0,0,.1); position:relative; overflow:hidden;
    }
    ...
    .form-title {
      font-size:2.2rem; font-weight:700; background:linear-gradient(45deg,#6b46c1,#ef4444);
      -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; margin-bottom:24px; text-align:center;
    }
    .form-group { margin-bottom:20px; }
    .form-label { display:block; font-weight:600; color:#1f2937; margin-bottom:8px; font-size:1.05rem; }
    .form-input {
      width:100%; padding:16px 20px; border:3px solid #e5e7eb; border-radius:15px;
      font-size:1.1rem; font-weight:500; transition:.3s ease; background:#fff;
    }
    ...
    .error-message {
      display:none; justify-content:center; align-items:center; background:#fff0f0;
      border:2px solid #ef4444; border-radius:12px; padding:14px 22px; margin:10px auto 0;
      max-width:520px; box-shadow:0 2px 12px rgba(239,68,68,0.07);
      font-size:1.02rem; font-weight:600; color:#b91c1c; text-align:center;
      letter-spacing:0.01em; min-height:1.2em; transition:all .2s;
    }

    .voucher-result {
      display:none; background:linear-gradient(135deg,#10b981,#059669); color:#fff; padding:34px;
      border-radius:20px; text-align:center; margin-top:26px; animation:slideIn .5s ease;
    }
    @keyframes slideIn { from{opacity:0; transform:translateY(20px)} to{opacity:1; transform:translateY(0)} }
    .voucher-number { font-size:2.6rem; font-weight:800; margin:12px 0 6px; text-shadow:2px 2px 4px rgba(0,0,0,.3); letter-spacing:2px; }
    .voucher-details { background:rgba(255,255,255,.12); padding:22px; border-radius:15px; margin:18px 0; }
    .voucher-details h3 { font-size:1.35rem; margin-bottom:12px; }
    .voucher-info { display:grid; grid-template-columns:repeat(auto-fit,minmax(200px,1fr)); gap:12px; text-align:left; }
    .voucher-info-item { background:rgba(255,255,255,.12); padding:14px; border-radius:10px; }
    .voucher-info-label { font-size:.9rem; opacity:.85; margin-bottom:4px; }
    .voucher-info-value { font-weight:700; font-size:1.05rem; word-break:break-word; }
    ...
    .alert { padding:18px; border-radius:15px; margin:14px 0; font-weight:500; }
    .alert-warning { background:#fffbeb; color:#92400e; border:2px solid #f59e0b; }

    @media (max-width:900px){ .row{grid-template-columns:1fr} .hero h1{font-size:2.4rem} }
  </style>
</head>
<body>
  ...
  <main>
    ...
    <section class="container">
        ...
        <form id="reprintForm" method="POST" novalidate>
          ...
          <div class="row">
            <div class="form-group">
              ...
              <input type="text" id="cpfCnpj" name="cpfCnpj" class="form-input" placeholder="Digite CPF ou CNPJ..." maxlength="18">
            </div>
            <div class="form-group">
              <label for="numeroNota" class="form-label">📄 Número da Nota Fiscal</label>
              <input type="text" id="numeroNota" name="numeroNota" class="form-input" placeholder="Digite o número da nota..." maxlength="25">
            </div>
          </div>
          <div class="form-group">
          ...
          <div style="text-align:center; margin-top:12px;">
            <button type="submit" class="btn btn-primary" id="submitBtn" style="font-size:1.1rem; padding:16px 34px;">
      ...
      <div class="alert alert-warning">
        ⚠️ <strong>Importante:</strong> Informe o CPF ou CNPJ, número da nota fiscal e selecione a loja onde foi feita a compra.
      </div>
    </section>
  </main>
